  ...
  return (
    <>
      ...
      <main className="container-about">
        <h1>Quem Somos</h1>
        <p>Paty Biju, uma Loja de Bijuteria em Palhoça - SC / Brazil.</p>
        <p>
          {" "}
          ...
          local e levaria o nome de Paty Biju.
        </p>
        <p>
        ...
        <p>
          A Paty Biju foi inaugurada com grande entusiasmo pela comunidade
